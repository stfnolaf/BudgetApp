...
#Preview {
    ...
    ({
        ...
        return BudgetViewBackup(budget: budget, categories: categories, onAddBudgetItem: { name, budget, category, amount, frequency in }, showBudgetSelectionSheet: $showBudgetSelectionSheet)
    })()
}
